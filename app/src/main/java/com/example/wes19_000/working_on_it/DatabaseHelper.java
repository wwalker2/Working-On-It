...
public class DatabaseHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public static final String TOOLS_COLUMN = "tools";
    ...
    public boolean insertJob(JobEntry job) {
        ...
        contentValues.put(this.TOOLS_COLUMN, job.getToolList());
    ...
    public Cursor updateDataforEdit(String selectedName, String editName, String editAddress, String editPhone, String editDescription, String editTools, double editPay, String editStart, String editEnd) {
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public Cursor getData(String name) {
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor result = db.rawQuery("SELECT " + NAME_COLUMN + ", " + ADDRESS_COLUMN + ", " + PHONE_COLUMN + ", " + DESCRIPTION_COLUMN + ", " + TOOLS_COLUMN + ", " + PAY_COLUMN + ", " + START_DATE_COLUMN + ", " + END_DATE_COLUMN +
                " FROM " + TABLE_NAME +
